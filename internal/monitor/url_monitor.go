...
import (
	...
	_ "github.com/KevinKalt0/urlshortener/internal/models"   // Importe les modèles de liens
	"github.com/KevinKalt0/urlshortener/internal/repository" // Importe le repository de liens
)
